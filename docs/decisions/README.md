...
> ADR numbers are not reused. Gaps (002, 004–008) are historical — those ADRs were specific to the Chrome-extension architecture that was retired on 2026-05-22. New ADRs continue from the next unused number (009).
